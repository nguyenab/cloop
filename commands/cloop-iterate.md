...
allowed-tools: ["Read", "Write", "Edit", "Glob", "Bash", "Workflow", "CronDelete", "CronList", "PushNotification"]
...
this slug, using the roles set in its plan. Do exactly one iteration, then stop. The timer fires the
next one.
